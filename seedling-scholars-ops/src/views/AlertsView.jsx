...
export default function AlertsView({ profile, accessibleSiteIds }) {
  ...
  // Admins and Site Directors (account_holder) see every staff member's
  // compliance at the houses they can access — only a teacher is limited to
  // just their own items.
